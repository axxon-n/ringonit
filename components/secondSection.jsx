...
<section id="story" className="border-1 rounded-2xl pb-10 border-[#f9e285] h-full flex flex-col items-center justify-center gap-4 w-full" data-scroll-section>
	...
	<ProfileCard
		...
		name="Cristina"
		description="Si dice che la coppia sia per definizione un'insieme di tre persone di cui una è momentaneamente assente. Non è sempre così! A 25 anni eravamo già in tre. Con la scoperta del meraviglioso papino, la nostra definizione di coppia diventa un'insieme di cinque di cui uno momentaneamente assente."
    ...
    <ProfileCard
		...
		name="Andrea"
		description="Sin dai 19 anni da un singolo sono diventato parte di una meravigliosa vita! E mami mi ha insegnato molto sulla vita... Soprattutto ho imparato che in una coppia è molto importante raggiungere l'equilibrio: una volta ha ragione lei e una volta ho torto io"
    ...
    <Card ref={sempreInsieme} className="opacity-0 h-full sm:h-[60%] sm:mt-[20%] overflow-visible sm:overflow-hidden col-span-12 sm:col-span-4 h-full z-20">
	  ...
	  <CardBody className="px-3 sm:py-0 py-10 text-small justify-center text-center text-[#f9e28590]">
	    <p>
	      Sono passati 13 anni. Siamo migliori amici. Il diario umano e la dolce metà l'uno per l'altra. Siamo il significato del nostro mondo. <br/> Si dice che l'amore faccia fare cose pazze... vero! Noi per esempio CI SPOSIAMO!
	    </p>
	  </CardBody>
	</Card>
